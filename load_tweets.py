...
def insert_tweet(connection,tweet):
    ...
    with connection.begin() as trans:
        ...
        sql = sqlalchemy.sql.text('''
            INSERT INTO users (id_users, created_at, updated_at, screen_name, name, location, id_urls, description,
protected, verified, friends_count, listed_count, favourites_count, statuses_count, withheld_in_countries)
